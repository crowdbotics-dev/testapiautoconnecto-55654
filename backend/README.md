...
## Project Structure
    ...
    ├── testapiautoconnecto_55654  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_55654`
...
2. Clone this repo and `cd testapiautoconnecto_55654`
